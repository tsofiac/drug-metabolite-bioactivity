...
This repository contains the code used to generate the results reported in the article Larsson et al. (2026) "Systematic Computational Identification of Active Drug Metabolites Across the Human Proteome," currently available on the [ChemRxiv]().
